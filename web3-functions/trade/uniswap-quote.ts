...
const WETH_TOKEN = new Token(ChainId.POLYGON, WETH_ADDRESS, 18, "WETH", "Wrapped Ether");

export const USDC_TOKEN = new Token(ChainId.POLYGON, USDC_ADDRESS, 6, "USDC", "USD//C");
